...
class ChatList extends React.Component {
  ...
  rowRenderer = ({
    ...
    if (chat_state.profile_image != null) {
      image = <img className="image-icon" src={"dc://" + chat_state.profile_image} alt="chat avatar"/>;
    }
  ...
  render() {
    ...
    let rowCount = account.chat_states ? Object.keys(account.chat_states).length : 0
